    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-4 sm:py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-playfair font-bold text-gold mb-2">Welcome Back</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Sign in to your Avancé Apparel account</p>
        </div>
            ...
            <div className="mt-6 text-center space-y-4">
              ...
              <div className="border-t border-border pt-4">
                <Link href="/admin-login">
                  <Button 
                    variant="outline" 
                    className="w-full border-gold text-gold hover:bg-gold hover:text-black transform hover:scale-105 transition-all duration-200"
                  >
                    Admin Login
                  </Button>
                </Link>
                <p className="text-xs text-gray-400 mt-2">
                  Email: admin@avance.com | Password: avance2025
                </p>
              </div>
            </div>
          </CardContent>
